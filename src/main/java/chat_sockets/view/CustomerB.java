...
public class CustomerB extends JFrame implements Observer {
    ...
    public CustomerB() {
        ...
        chatArea.setBackground(new Color(250, 250, 240)); // color leve distinto
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(CustomerB::new);
    }
}